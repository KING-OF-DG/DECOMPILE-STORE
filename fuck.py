...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://raw.githubusercontent.com/FARUK501-CYBER/File-Cloning/main/line.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print(' WhatsApp : +8801631169330')
        input('\033[1;97m Press Enter To Send Token')
        os.system("xdg-open https://wa.me/+880163116330")
        reg()
