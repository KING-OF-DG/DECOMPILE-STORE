#THIS TOOLS COADED BY MR. SABBIR
# -*- coding:utf-8 -*-
# SO DON’T TRY DECODE & DECOMPILE
# BEACUSE I FUCK YOU
...
Ganz = """\033[1;92m╔═════════════════════════════════════════════════╗
║ ➣ DEVELOPER  :       MR. SABBIR                 ║
║ ➣ FACEBOOK   :       RIPON AHMED SABBIR         ║
║ ➣ WHATSAPP   :       SABBIR-WROLD               ║
║ ➣ GITHUB     :       SABBIR404-CYBER            ║
║ ➣ TOOLS      :       COMPILE / DECOMPILE        ║
╚═════════════════════════════════════════════════╝"""
tod = []
